...
7 Player2 Deck & Discard remain the same  */ 
    ...
    printf("----------------- Unit Test 3 - Testing Refactored Village Function ----------------\n\n");
    ...
    villageCard(card, choice1, choice2, choice3, &testG, handpos, &bonus, thisPlayer);
   ...
   /* Print Player 1 Hand & Details After Smithy Function */ 
    ...
    {
        printf("villageCard(): PASS - Hand was 1 Card bigger after the function than before as expected\n");
        score++;}
    else
        printf("villageCard(): FAIL - Hand was not 1 Card bigger after the function than before as expected\n");
    ...
    if (preDeckCount+preHandCount+prePlayedCardCount+preDiscardCount == postPlayedCardCount+postDeckCount+postHandCount+postDiscardCount) {
        printf("villageCard(): PASS - All Cards Accounted for, no cards lost\n"); 
        score++; }
    else
        printf("villageCard(): FAIL - Not all Cards Accounted for, cards lost\n"); 
    ...
    if (playerTurnPre==playerTurnPost) {
        printf("villageCard(): PASS - Function did not change the player Turn as expected\n"); 
        score++; }
    else 
        { printf("villageCard(): FAIL - Function changed the player turn in error\n");}
    ...
    if (preNumBuys==postNumBuys) {
        printf("villageCard(): PASS - Function did not change the player buys count as expected\n"); 
        score++;}
    else 
        { printf("villageCard(): FAIL - Function changed the player buys count in error\n"); }
    ...
    if (preActions+2==postActions) {
        printf("villageCard(): PASS - Function increased actions by 2 count as expected\n"); 
        score++;}
    else 
        { printf("villageCard(): FAIL - Function did not increase action count by 2, error\n"); }
    ...
    if (preProvince==postProvince && preDuchy==postDuchy && preEstate==postEstate) {
        printf("villageCard(): PASS - Function did not change the player supply cards count as expected\n"); 
        score++; }
    else 
        { printf("villageCard(): FAIL - Function changed the player supply cards count in error\n");}
    ...
    if (prePhase==postPhase) {
        printf("villageCard(): PASS - Function did not change the game phase as expected\n"); 
        score++; }
    else 
        { printf("villageCard(): FAIL - Function changed the game phase in error\n");}
    ...
    if (otherDeckPre==otherDeckPost && otherDiscardPre==otherDiscardPost) {
        printf("villageCard(): PASS - Function did not change the other player's cards as expected\n"); 
        score++; }
    else 
        { printf("villageCard(): FAIL - Function changed the othe player's cards in error\n"); }
